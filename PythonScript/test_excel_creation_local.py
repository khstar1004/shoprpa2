...
def run_excel_creation_test():
    ...
    row1.update({
        ...
        '본사 이미지': r"C:\RPA\Image\Main\Haereum\haereum__AGK_NORDIC__블랙_프리미엄_28_프라이팬_콤비_111b244db2.jpg",
        '고려기프트 이미지': r"C:\RPA\Image\Main\kogift_pre\kogift_pre_12c8c525c8_1c8b17f355.jpg",
